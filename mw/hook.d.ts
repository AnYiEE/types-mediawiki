...
declare global {
	namespace mw {
		 ...
		 * @see https://doc.wikimedia.org/mediawiki-core/master/js/#!/api/mw.hook
		 */
		function hook(event: 'util.addPortlet'): Hook<[portlet: HTMLElement, before: string | undefined]>;
		 ...
		 * @see https://doc.wikimedia.org/mediawiki-core/master/js/#!/api/mw.hook
		 */
		function hook(event: 'wikipage.diff.diffTypeSwitch'): Hook<[inlineToggleSwitch: OO.ui.ToggleSwitchWidget]>;
