...
type ModuleState = 'error' | 'executing' | 'loaded' | 'loading' | 'missing' | 'ready' | 'registered';
...
declare global {
	namespace mw {
		...
		namespace loader {
			 ...
			 * @return {JQuery.Promise<ModuleRequire>} With a `require` function
			 ...
			 */
			function addScriptTag(src: string, callback?: () => void, modules?: string[]): HTMLScriptElement;
			 ...
			 * @return {string[]} List of dependencies, including 'module'.
