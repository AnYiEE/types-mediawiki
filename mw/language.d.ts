declare global {
	namespace mw {
		...
		namespace language {
			 ...
			 */
			function convertPlural(count: number, forms: string[], explicitPluralForms?: Record<string, any>): string;
			 ...
			 */
			function flipTransform(...Transformation: Array<Record<string, any>>): Record<string, any>;
