...
declare global {
	namespace mw {
		...
		class Api {
			 ...
			 */
			ajax(parameters: UnknownApiParams, ajaxOptions?: JQuery.AjaxSettings): JQuery.Promise<ApiResponse>;
			 ...
			 */
			assertCurrentUser<T extends UnknownApiParams>(query: T): Omit<T, keyof AssertUser> & AssertUser;
			 ...
			 */
			create(title: TitleLike, params: ApiEditPageParams, content: string): JQuery.Promise<EditResult>;
			 ...
			 */
			get(parameters: UnknownApiParams, ajaxOptions?: JQuery.AjaxSettings): JQuery.Promise<ApiResponse>;
			 ...
			 * @since 1.22
			 * @param {string} type Token type
			 * @param {UnknownApiParams|ApiAssert} [additionalParams] Additional parameters for the API (since 1.35). When given a string, it's treated as the `assert` parameter (since 1.25)
			 * @returns {JQuery.Promise<string>} Received token
			 * @see https://doc.wikimedia.org/mediawiki-core/master/js/#!/api/mw.Api-method-getToken
			 */
			getToken(type: ApiTokenType, additionalParams?: ApiQueryTokensParams | ApiAssert): JQuery.Promise<string>;
			/** @deprecated Use "csrf" instead */
			getToken(
				type: ApiLegacyTokenType,
				additionalParams?: ApiQueryTokensParams | ApiAssert
			): JQuery.Promise<string>;
			getToken(type: string, additionalParams?: ApiQueryTokensParams | ApiAssert): JQuery.Promise<string>;
			 ...
			 */
			loadMessages(messages: string | string[], options?: ApiQueryAllMessagesParams): JQuery.Promise<boolean>;
			 ...
			 */
			loadMessagesIfMissing(messages: string[], options?: ApiQueryAllMessagesParams): JQuery.Promise<boolean>;
			 ...
			 */
			post(parameters: UnknownApiParams, ajaxOptions?: JQuery.AjaxSettings): JQuery.Promise<ApiResponse>;
			 ...
			 */
			postWithEditToken(params: UnknownApiParams, ajaxOptions?: JQuery.AjaxSettings): JQuery.Promise<ApiResponse>;
			 ...
			 */
			rollback(page: TitleLike, user: string, params?: ApiRollbackParams): JQuery.Promise<RollbackInfo>;
			 ...
			 *
			 * @param {Blob|HTMLInputElement|File} file HTML `input type=file` element with a file already inside of it, or a File object.
			 * @param {ApiUploadParams} data Other upload options, see `action=upload` API docs for more
			 * @returns {JQuery.Promise<ApiResponse>}
			 * @see https://doc.wikimedia.org/mediawiki-core/master/js/#!/api/mw.Api.plugin.upload-method-upload
			 */
			upload(file: Blob | HTMLInputElement | File, data: ApiUploadParams): JQuery.Promise<ApiResponse>;
			 ...
			 */
			uploadToStash(file: HTMLInputElement | File, data?: ApiUploadParams): JQuery.Promise<FinishUpload>;
