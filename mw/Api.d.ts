...
declare global {
	namespace mw {
		...
		class Api {
			 ...
			 */
			uploadToStash(file: File | HTMLInputElement, data?: ApiUploadParams): JQuery.Promise<FinishUpload>;
		...
		namespace Api {
			...
			interface EditTransform {
				...
				(
					revision: Revision
				): string | ApiEditPageParams | JQuery.Promise<string> | JQuery.Promise<ApiEditPageParams>;
			}
