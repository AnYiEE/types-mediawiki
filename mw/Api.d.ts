...
declare global {
	namespace mw {
		...
		class Api {
			...
			edit(
				title: TitleLike,
				transform: (revision: Revision) => string | Omit<ApiEditPageParams, 'action' | 'title'>
			): JQuery.Promise<EditResult>;
			...
			newSection(
				...
				header: string,
				message: string,
				additionalParams?: Omit<ApiEditPageParams, 'action' | 'section' | 'summary' | 'text' | 'title'>
			): JQuery.Promise<ApiResponse>;
			 ...
			 */
			upload(
				file: Blob | HTMLInputElement | File,
