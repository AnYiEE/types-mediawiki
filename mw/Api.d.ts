...
declare global {
	namespace mw {
		...
		class Api {
			 ...
			 */
			edit(title: TitleLike, transform: (revision: Revision) => string | ApiEditPageParams): JQuery.Promise<any>;
			 ...
			 */
			getMessages(messages: string | string[], options?: ApiQueryAllMessagesParams): JQuery.Promise<ApiResponse>;
			 ...
			 */
			loadMessages(messages: string | string[], options?: ApiQueryAllMessagesParams): JQuery.Promise<ApiResponse>;
