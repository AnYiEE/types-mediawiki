declare global {
	interface JQuery {
		 ...
		 * @see https://doc.wikimedia.org/mediawiki-core/master/js/jQueryPlugins.html#.textSelection
		 */
		textSelection(command: 'encapsulateSelection', options?: TextSelectionEncapsulateOptions): this;
		...
		textSelection(command: 'getCaretPosition', options?: GetCaretPositionOptions & {startAndEnd?: false}): number;
		textSelection(command: 'getCaretPosition', options?: GetCaretPositionOptions): number | [number, number];
		 ...
		 * @see https://doc.wikimedia.org/mediawiki-core/master/js/jQueryPlugins.html#.textSelection
		 */
		textSelection(command: 'scrollToCaretPosition', options?: ScrollToCaretPositionOptions): this;
