...
export interface ApiComparePagesParams extends ApiParams {
	...
	tosection?: string;
	prop?: OneOrMore<
		'comment' | 'diff' | 'diffsize' | 'ids' | 'parsedcomment' | 'rel' | 'size' | 'timestamp' | 'title' | 'user'
	>;
...
export interface ContentTranslationActionApiContentTranslationUnreviewedCheckParams extends ApiParams {
...
export interface ContentTranslationActionApiContentTranslationSuggestionListParams extends ApiParams {
...
export interface GlobalPreferencesApiGlobalPreferenceOverridesParams extends ApiParams {
	...
	resetkinds?: OneOrMore<
		'all' | 'registered' | 'registered-checkmatrix' | 'registered-multiselect' | 'special' | 'unused' | 'userjs'
	>;
...
export interface GrowthExperimentsApiInvalidatePersonalizedPraiseSuggestionParams extends ApiParams {
...
export interface GrowthExperimentsApiHelpPanelPostQuestionParams extends ApiParams {
	...
	body: string;
	source?: 'helpdesk' | 'helppanel' | 'homepage-mentorship' | 'mentor-helppanel' | 'mentor-homepage';
...
export interface AbuseFilterApiQueryAbuseLogParams extends ApiQueryParams {
	...
	afllimit?: limit;
	aflprop?: OneOrMore<
		'action' | 'details' | 'filter' | 'hidden' | 'ids' | 'result' | 'revid' | 'timestamp' | 'title' | 'user'
	>;
}
...
export interface ApiQueryAllUsersParams extends ApiQueryParams {
	...
	>;
	auprop?: OneOrMore<
		'blockinfo' | 'centralids' | 'editcount' | 'groups' | 'implicitgroups' | 'registration' | 'rights'
	>;
	aulimit?: limit;
...
export interface ContentTranslationActionApiQueryPublishedTranslationsParams extends ApiQueryParams {
	from?: string;
	to?: string;
	limit?: limit;
	offset?: string;
...
export interface ApiQueryLogEventsParams extends ApiQueryParams {
	leprop?: OneOrMore<
		'comment' | 'details' | 'ids' | 'parsedcomment' | 'tags' | 'timestamp' | 'title' | 'type' | 'user' | 'userid'
	>;
	letype?:
		| ''
		| 'abusefilter'
...
export interface ReadingListsApiReadingListsCreateParams extends ReadingListsApiQueryReadingListsParams {
	command: 'create';
	name?: string;
	description?: string;
	batch?: string;
...
export interface ReadingListsApiReadingListsCreateEntryParams
	extends Omit<ReadingListsApiQueryReadingListsParams, 'list'> {
	command: 'createentry';
	list: number;
	project?: string;
	title?: string;
...
export interface ReadingListsApiReadingListsDeleteParams extends Omit<ReadingListsApiQueryReadingListsParams, 'list'> {
	command: 'delete';
	list?: number;
	batch?: string;
}

export interface ReadingListsApiReadingListsDeleteEntryParams extends ReadingListsApiQueryReadingListsParams {
	command: 'deleteentry';
	entry?: number;
	batch?: string;
}

export interface ReadingListsApiReadingListsSetupParams extends ReadingListsApiQueryReadingListsParams {
	command: 'setup';
}

export interface ReadingListsApiReadingListsTeardownParams extends ReadingListsApiQueryReadingListsParams {
	command: 'teardown';
}

export interface ReadingListsApiReadingListsUpdateParams extends Omit<ReadingListsApiQueryReadingListsParams, 'list'> {
	command: 'update';
	list?: number;
	name?: string;
	description?: string;
